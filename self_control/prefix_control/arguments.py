...
def get_args():
    ...
    # names
    parser.add_argument("--training_set_name", type=str, default=None, help="Name of the training dataset")
    parser.add_argument("--eval_set_name", type=str, default=None, help="Name of the eval dataset")
