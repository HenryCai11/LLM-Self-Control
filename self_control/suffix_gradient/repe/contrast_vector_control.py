...
def forward_contrast_vector(self,
    ...
    causal_mask = _prepare_4d_causal_attention_mask(attention_mask, (batch_size, seq_length), inputs_embeds, past_seen_tokens)
    ...
    if compute_contrast:
        ...
        pos_attention_mask = _prepare_4d_causal_attention_mask_for_sdpa(pos_attention_mask, (batch_size, seq_length), embeds_p, past_seen_tokens)
        neg_attention_mask = _prepare_4d_causal_attention_mask_for_sdpa(neg_attention_mask, (batch_size, seq_length), embeds_n, past_seen_tokens)
